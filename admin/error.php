...
<html lang="en">
  <head>
    ...
    <link href="<?= $config->site; ?>/template/clean/css/custom.css" rel="stylesheet">
    <link href='http://fonts.googleapis.com/css?family=Pacifico' rel='stylesheet' type='text/css'>
    <link href='http://fonts.googleapis.com/css?family=Asap' rel='stylesheet' type='text/css'>
    
    <link href="<?= $config->site; ?>/template/clean/css/homepage.css" rel="stylesheet">
    ...
    <div class="main">
		...
		<div class="container">
		    ...
		    <div class="content text-center center">
               ...
               <a class="btn btn-default" href="<?= $config->site; ?>/admin/index.php?view=cpanel"><?= $lang->replace('CW_ERROR_RETURN_TO_CPANEL'); ?></a>
		    </div>		    		
